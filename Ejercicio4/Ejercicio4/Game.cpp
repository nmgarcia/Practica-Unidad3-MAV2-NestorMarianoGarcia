...
void Game::DoEvents()
{
	...
	if (Keyboard::isKeyPressed(Keyboard::Left))
		cajaBody->ApplyForceToCenter(b2Vec2(-1500.0f, 0.0f),true);
	if (Keyboard::isKeyPressed(Keyboard::Right))
		cajaBody->ApplyForceToCenter(b2Vec2(1500.0f, 0.0f), true);
	if (Keyboard::isKeyPressed(Keyboard::Down))
		cajaBody->ApplyForceToCenter(b2Vec2(0.0f, 1500.0f), true);
...
void Game::InitPhysics()
{
	...
	cajaBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 10.0f, 10.0f, 1.0f, 0.5, 0.5f);
